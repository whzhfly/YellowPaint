...
class YELLOWPAINTEDITOR_API FLGNodeHandler_GetArrayItem : public FLGNodeHandler
{
public:
...
REGISTER_LG_NODE_HANDLER(UK2Node_GetArrayItem, FLGNodeHandler_GetArrayItem);
