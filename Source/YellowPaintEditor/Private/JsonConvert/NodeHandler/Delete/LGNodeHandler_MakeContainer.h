...
// class YELLOWPAINTEDITOR_API FLGNodeHandler_MakeContainer : public FLGNodeHandler
// {
// public:
...
// REGISTER_LG_NODE_HANDLER(UK2Node_MakeContainer, FLGNodeHandler_MakeContainer);
