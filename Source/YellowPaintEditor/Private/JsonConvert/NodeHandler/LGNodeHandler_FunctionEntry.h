...
class YELLOWPAINTEDITOR_API FLGNodeHandler_FunctionEntry : public FLGNodeHandler
{
public:
...
REGISTER_LG_NODE_HANDLER(UK2Node_FunctionEntry, FLGNodeHandler_FunctionEntry);
